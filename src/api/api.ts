...
export const APIS = [ActionsApi, ApplicationsApi, ClientsApi, ConsumersApi, DirectoriesApi, EmailVerificationApi, EndpointsApi, FilesApi, InteractiveViewsApi, InvitesApi, LoginApi, MongoDataApi, MongoDatabasesApi, MongoModelsApi, OrganizationsApi, PasswordResetApi, ProvidersApi, RolesApi, SignupApi, TenantsApi, UsersApi];
